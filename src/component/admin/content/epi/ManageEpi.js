...
import ModaDelete from './ModalDelete';
import {deleteEpi} from '../../../../services/epsService';
...
const ManageEpi = (props)=>{
 ...
 const handleDeleteConfirm = async()=>{
    let respone = await deleteEpi(dataDelete);
    ...
    <div className="manage-epi-container">
        ...
        />
        <ModaDelete dataDelete={dataDelete} show={showModalDelete} handleDeleteConfirm={handleDeleteConfirm} 
        handleDeleteShowClose={handleDeleteShowClose} />
    </div>
    )
}
