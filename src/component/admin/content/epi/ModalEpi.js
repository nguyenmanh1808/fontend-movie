...
const ModalEpi = (props)=> {
  ...
  useEffect(()=>{
    if(action === "EDIT"){
        ...
        setPreVideo(`${url}${dataEpi.ep_url}`)
    }
  },[dataEpi])
      ...
      <Modal show={show} onHide={handleClose} size='xl' backdrop ="static" className="modal-add-user">
        ...
        <div className='col-md-12'>
            <label  className='form-lable lable-upload' htmlFor='lableUpload'> 
                <FcPlus/>
                 Upload video</label>
            <input disabled={action === "EDIT" ? true : false } id='lableUpload' type='file' hidden    onChange={event => handleVideoUpload(event)} />
        </div>
